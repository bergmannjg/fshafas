...
setup(
    ...
    packages=[
        'fshafas',
        'fshafas/profiles',
        'fshafas/fable_modules/fs_hafas_api_python',
        'fshafas/fable_modules/db_vendo_python',
        'fshafas/fable_modules/db_vendo_python/lib',
        'fshafas/fable_modules/db_vendo_python/parse',
